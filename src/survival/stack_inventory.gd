...
const SCHEMA: int = 4
const PREVIOUS_SCHEMA: int = 3
const OLDER_SCHEMA: int = 2
const LEGACY_SCHEMA: int = 1
const SLOT_COUNT: int = 64
const PREVIOUS_SLOT_COUNT: int = 40
const OLDER_SLOT_COUNT: int = 36
...
func decode(payload: Dictionary) -> bool:
	...
	match schema:
		...
		OLDER_SCHEMA:
			expected_slots = OLDER_SLOT_COUNT
		PREVIOUS_SCHEMA:
