...
static func append_pool_metrics(target: Dictionary, pool: TeknikChunkBuildPool) -> Dictionary:
	...
	target["stream_last_discarded_buffered_reports"] = pool.last_discarded_buffered_reports()
	target["stream_total_discarded_buffered_reports"] = pool.total_discarded_buffered_reports()
